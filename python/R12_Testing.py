...
# -*- coding: utf-8 -*-
"""
Created on Tue Jan 19 12:21:26 2021
...
df_r12tat = pd.read_csv(f'/Users/shivambhatnagar/OneDrive - Genomics England Ltd/Genomics England/PLCM Dev/Tables/{date}/row_12.csv')

df_join_biobank_r12tat = pd.merge(df_biobankall, df_r12tat, how="left", on="SAMPLE_IDENTIFIER")

df_join_biobankr12tat_grecordall = pd.merge(df_join_biobank_r12tat, df_grecordall, how="left", on="LOCAL_PATIENT_IDENTIFIER_(EXTENDED)")

df_out = df_join_biobankr12tat_grecordall
...
if x.lower() == 'y':        
    plcm_df.to_excel(f'/Users/shivambhatnagar/OneDrive - Genomics England Ltd/Genomics England/PLCM Dev/Tables/{date}/output/row12_testing.xlsx', index=False)
else:
    pass
