...
fpath2 = f'/Users/shivambhatnagar/OneDrive - Genomics England Ltd/Genomics England/Other/PLCM Dev/Tables/{date}/ngis_snp_referring_glh.csv'
df_biobankall = pd.read_csv(f'/Users/shivambhatnagar/OneDrive - Genomics England Ltd/Genomics England/Other/PLCM Dev/Tables/{date}/ngis_biobank_all.csv')
df_grecordall = pd.read_csv(f'/Users/shivambhatnagar/OneDrive - Genomics England Ltd/Genomics England/Other/PLCM Dev/Tables/{date}/ngis_genomicrecord_all.csv')
...
df_r12.to_csv(f'/Users/shivambhatnagar/OneDrive - Genomics England Ltd/Genomics England/Other/PLCM Dev/Tables/{date}/row_12.csv', index=False)
df_rsnp.to_csv(f'/Users/shivambhatnagar/OneDrive - Genomics England Ltd/Genomics England/Other/PLCM Dev/Tables/{date}/row_snp.csv', index=False)
df_r13.to_csv(f'/Users/shivambhatnagar/OneDrive - Genomics England Ltd/Genomics England/Other/PLCM Dev/Tables/{date}/row_13.csv', index=False)
df_r14.to_csv(f'/Users/shivambhatnagar/OneDrive - Genomics England Ltd/Genomics England/Other/PLCM Dev/Tables/{date}/row_14.csv', index=False)
