...
# -*- coding: utf-8 -*-
"""
Created on Mon May 17 16:12:58 2021
...
df_rsnptat = pd.read_csv(f'/Users/shivambhatnagar/OneDrive - Genomics England Ltd/Genomics England/PLCM Dev/Tables/{date}/row_snp.csv')

df_join_biobank_rsnptat = pd.merge(df_biobankall, df_rsnptat, how="left", on="SAMPLE_IDENTIFIER")

df_join_biobankrsnptat_grecordall = pd.merge(df_join_biobank_rsnptat, df_grecordall, how="left", on="LOCAL_PATIENT_IDENTIFIER_(EXTENDED)")

df_out = df_join_biobankrsnptat_grecordall
...
if x.lower() == 'y':        
    plcm_df.to_excel(f'/Users/shivambhatnagar/OneDrive - Genomics England Ltd/Genomics England/PLCM Dev/Tables/{date}/output/row_snp.xlsx', index=False)
else:
    pass
