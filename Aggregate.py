...
fpath1 = f'/Users/shivambhatnagar/OneDrive - Genomics England Ltd/Genomics England/PLCM/Tables/{d}/output/row9_transportsamples.xlsx'
fpath2 = f'/Users/shivambhatnagar/OneDrive - Genomics England Ltd/Genomics England/PLCM/Tables/{d}/output/row11_transportplate.xlsx'
fpath3 = f'/Users/shivambhatnagar/OneDrive - Genomics England Ltd/Genomics England/PLCM/Tables/{d}/output/row12_testing.xlsx'
fpath4 = f'/Users/shivambhatnagar/OneDrive - Genomics England Ltd/Genomics England/PLCM/Tables/{d}/output/row13_bioinformatics.xlsx'
fpath5 = f'/Users/shivambhatnagar/OneDrive - Genomics England Ltd/Genomics England/PLCM/Tables/{d}/output/row14_dss.xlsx'

df_r9 = pd.read_excel(fpath1)
df_r11 = pd.read_excel(fpath2)
df_r12 = pd.read_excel(fpath3)
df_r13 = pd.read_excel(fpath4)
df_r14 = pd.read_excel(fpath5)

df_list = [df_r9, df_r11, df_r12, df_r13, df_r14]
...
# Filtering out dates
plcm_df = plcm_df[plcm_df['ACTIVITY_START_DATE_AND_TIME_(CONTRACT_MONITORING)'] <= dt.datetime(2021, 3, 31, 0,0,0)]
plcm_df = plcm_df[plcm_df['ACTIVITY_END_DATE_AND_TIME_(CONTRACT_MONITORING)'] <= dt.datetime(2021, 3, 31,0,0,0)]
...
plcm_df['HOSPITAL_PROVIDER_SPELL_NUMBER'] = ''
plcm_df['ATTENDANCE_IDENTIFIER'] = ''
# No NHS Number match
...
# COMMISSIONED_SERVICE_CATEGORY_CODE, SPECIALISED SERVICE CODE
plcm_df['COMMISSIONED_SERVICE_CATEGORY_CODE'] = 21
plcm_df['SPECIALISED_SERVICE_CODE'] = 'NCBPS20Z'
...
# TAT Standards --- HERE
#disease_area
fpath6 = f'/Users/shivambhatnagar/OneDrive - Genomics England Ltd/Genomics England/PLCM/Tables/{d}/ngis_diseasearea_all.csv'
...
fin_month = {1:'Jan', 2:'Feb', 3:'Mar', 10:'Oct', 11:'Nov', 12:'Dec'}
fin_month_2 = {'Oct': 7, 'Nov' : 8, 'Dec' : 9, 'Jan' : 10, 'Feb' : 11, 'Mar':12}
...
plcm_df['TEST_URGENCY'] = plcm_df['TEST_URGENCY'].apply(lambda x: 2 if x == 'Routine' else 1)
...
plcm_df['SAMPLE_PREPARATION_QUALITY_CONTROL'] = plcm_df['SAMPLE_PREPARATION_QUALITY_CONTROL'].apply(lambda x: 'Y' if x == 'Pass' else 'N')
...
plcm_df.to_excel(f'/Users/shivambhatnagar/OneDrive - Genomics England Ltd/Genomics England/PLCM/PLCM_Excel/Dev/{d}/PLCM_v0.xlsx', index=False)
