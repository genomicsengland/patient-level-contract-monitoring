...
df_r11tat = pd.read_csv(f'/Users/shivambhatnagar/OneDrive - Genomics England Ltd/Genomics England/PLCM/Tables/{date}/row_11.csv')
...
if x.lower() == 'y':        
    plcm_df.to_excel(f'/Users/shivambhatnagar/OneDrive - Genomics England Ltd/Genomics England/PLCM/Tables/{date}/output/row11_transportplate.xlsx', index=False)
else:
    pass
