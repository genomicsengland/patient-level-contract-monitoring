-- PLCM Query ROW 11 for Transport Plate TATs
select referral_id as "NGIS_REFERRAL_IDENTIFIER",
	   dispatched_sample_lsid as "SAMPLE_IDENTIFIER",
	   biobank_illumina_gel1008.plate_date_of_dispatch as "ACTIVITY_START_DATE_AND_TIME_(CONTRACT_MONITORING)",
	   biobank_illumina_gel1008.plate_date_of_dispatch as "ACTIVITY_END_DATE_AND_TIME_(CONTRACT_MONITORING)",
	   biobank_illumina_gel1008.plate_date_of_dispatch - biobank_illumina_gel1008.plate_date_of_dispatch as "TURNAROUND_TIME_(CALENDAR_DAYS)",
   	   case 
	   ...
	   'T1460' as "ORGANISATION_IDENTIFIER_(CODE_OF_SERVICE_PROVIDER)",
 	   'T1460' as "ORGANISATION_SITE_IDENTIFIER_(OF_SERVICE)",
  	   'TESTTRAPLATE' as "LOCAL_POINT_OF_DELIVERY_CODE"
