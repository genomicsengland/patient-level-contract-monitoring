...
# -*- coding: utf-8 -*-
"""
Created on Fri Jan 15 14:45:39 2021
...
df_r11tat = pd.read_csv(f'/Users/shivambhatnagar/OneDrive - Genomics England Ltd/Genomics England/PLCM Dev/Tables/{date}/row_11.csv')

df_join_biobank_r11tat = pd.merge(df_biobankall, df_r11tat, how="left", on="SAMPLE_IDENTIFIER")

df_join_biobankr11tat_grecordall = pd.merge(df_join_biobank_r11tat, df_grecordall, how="left", on="LOCAL_PATIENT_IDENTIFIER_(EXTENDED)")

df_out = df_join_biobankr11tat_grecordall
...
x = input('Do you want to write to excel file?: y/n')

if x.lower() == 'y':        
    plcm_df.to_excel(f'/Users/shivambhatnagar/OneDrive - Genomics England Ltd/Genomics England/PLCM Dev/Tables/{date}/output/row11_transportplate.xlsx', index=False)
else:
    pass
